...
LSwitch использует модульную архитектуру с адаптерами для каждого DE:

- **utils/** - определение среды и чтение тем
- **adapters/** - GUI адаптеры для каждого DE
- **drivers/** - драйверы display серверов (X11, Wayland)
