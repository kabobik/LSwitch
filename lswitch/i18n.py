    ...
    def _load_translations(self) -> dict[str, dict[str, str]]:
        ...
        return {
            'en': {
                ...
                'auto_switch_threshold': 'Minimum characters before auto-conversion',
                'auto_switch_threshold_title': 'Auto-conversion minimum length',
                'auto_switch_threshold_prompt': 'Minimum buffered characters (0 = no extra restriction)',
                ...
                'settings_auto_switch_help': 'Detects and converts a word typed in the wrong layout when a word boundary, such as Space, is reached.',
                'settings_auto_switch_threshold_help': 'Automatic boundary conversion starts only after this many buffered characters. Zero adds no extra restriction.',
                'settings_auto_switch_mid_word_help': 'Detects a wrong layout and converts before the word is finished. This is a more aggressive mode.',
                'settings_mid_word_min_prefix_len_help': 'Number of characters that must be typed in the current word before mid-word detection starts.',
                'settings_system_dict_enabled_help': 'Adds installed Hunspell/MySpell dictionaries to mid-word detection.',
                ...
                'settings_user_dict_auto_confirm_help': 'If an automatic conversion is left unchanged until the next Space, record it as accepted in the user dictionary.',
            ...
            'ru': {
                ...
                'auto_switch_threshold': 'Минимум символов до автоконвертации',
                'auto_switch_threshold_title': 'Минимальная длина для автоконвертации',
                'auto_switch_threshold_prompt': 'Минимум символов в буфере (0 = без дополнительного ограничения)',
                ...
                'settings_auto_switch_help': 'Определяет и конвертирует слово в неверной раскладке при достижении границы слова, например пробела.',
                'settings_auto_switch_threshold_help': 'Автоконвертация на границе слова запускается только после указанного числа символов в буфере. Ноль не добавляет ограничения.',
                'settings_auto_switch_mid_word_help': 'Определяет неверную раскладку и конвертирует до завершения слова. Это более агрессивный режим.',
                'settings_mid_word_min_prefix_len_help': 'Число символов текущего слова, после которого запускается проверка во время набора.',
                'settings_system_dict_enabled_help': 'Добавляет установленные словари Hunspell/MySpell к проверке во время набора слова.',
                ...
                'settings_user_dict_auto_confirm_help': 'Если автоконвертация не отменена до следующего пробела, записывает её в пользовательский словарь как принятую.',
